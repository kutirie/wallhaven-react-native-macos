...
-(id)init
{
  if(self = [super init]) {
    ...
    [windowController setWindowFrameAutosaveName:@"wallhaven"];
...
- (void)setUpApplicationMenu
{
  ...
  [rootMenu addItemWithTitle:@"Quit wallhaven" action:@selector(terminate:) keyEquivalent:@"q"];
